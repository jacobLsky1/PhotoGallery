...
import com.bignerdranch.andriod.photogallery.api.PhotoInterceptor
    ...
    private fun fetchPhotoMetadata(flickrRequest: Call<FlickrResponse>): LiveData<List<GalleryItem>> {
        ...
        flickrRequest.enqueue(object : Callback<FlickrResponse>
        {
            ...
            override fun onResponse(
                ...
                Log.d(TAG,"recived ${galleryItems.size} items")
                amountOfPhotos = galleryItems.size
    }
})
...
what should you do with it? You will do what you do
with all data – put it in one or more model objects
 */

// page 895  - IMPORTANT! "Gson converter" from Json internet requests to lotlin objects